...
The Metabuli R207 database is downloaded separately. Download the tar.gz file from https://connectqutedu.sharepoint.com/:u:/s/metabuli_gtdb_207/IQCJOze9ZqfjQLRE-f1_3wQwATOgAvwwm8Rog3Nq3VVZTYs?e=C2p7kQ and put it into a new folder `tool_reference_data/metabuli`. Then extract it with
