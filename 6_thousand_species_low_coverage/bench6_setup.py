...
# Four-tool comparison over 1000 species, none above 1x coverage.
...
# Single synthetic community: 1000 distinct known GTDB r207 species, every one
# below 1x coverage and below 10% relative abundance.
datasets = ['known1000']
